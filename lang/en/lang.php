...
return [
    ...
    'catalogue' => [
        ...
        'menu_description' => 'Manage Catalogue Posts',
        'posts' => 'Posts',
        'create_post' => 'Catalogue post',
        'categories' => 'Categories',
        'create_category' => 'Catalogue category',
        'tab' => 'Catalogue',
        'access_posts' => 'Manage the catalogue posts',
        'access_categories' => 'Manage the catalogue categories',
        'access_other_posts' => 'Manage other users catalogue posts',
        'access_import_export' => 'Allowed to import and export posts',
        'access_publish' => 'Allowed to publish posts',
        'manage_settings' => 'Manage catalogue settings',
        'delete_confirm' => 'Are you sure?',
        'chart_published' => 'Published',
        'chart_drafts' => 'Drafts',
        'chart_total' => 'Total',
        'settings_description' => 'Manage catalogue settings',
    ...
    'posts' => [
        'list_title' => 'Manage the catalogue posts',
    ...
    'post' => [
        ...
        'categories_comment' => 'Select categories the catalogue post belongs to',
    ...
    'categories' => [
        'list_title' => 'Manage the catalogue categories',
    ...
    'category' => [
        ...
        'return_to_categories' => 'Return to the catalogue category list',
        'reorder' => 'Reorder Categories'
    ],
    'menuitem' => [
        'catalogue_category' => 'Catalogue category',
        'all_catalogue_categories' => 'All catalogue categories',
        'catalogue_post' => 'Catalogue post',
        'all_catalogue_posts' => 'All catalogue posts',
        'category_catalogue_posts' => 'Catalogue category posts'
    ],
    'settings' => [
        'category_title' => 'Category List',
        'category_description' => 'Displays a list of catalogue categories on the page.',
        'category_slug' => 'Category slug',
        'category_slug_description' => "Look up the catalogue category using the supplied slug value. This property is used by the default component partial for marking the currently active category.",
        ...
        'post_title' => 'Post',
        'post_description' => 'Displays a catalogue post on the page.',
        'post_slug' => 'Post slug',
        'post_slug_description' => "Look up the catalogue post using the supplied slug value.",
        ...
        'posts_description' => 'Displays a list of latest catalogue posts on the page.',
        ...
        'posts_no_posts_description' => 'Message to display in the catalogue post list in case if there are no posts. This property is used by the default component partial.',
        ...
        'posts_post_description' => 'Name of the catalogue post page file for the "Learn more" links. This property is used by the default component partial.',
        ...
        'rssfeed_catalogue' => 'Catalogue page',
        'rssfeed_catalogue_description' => 'Name of the main catalogue page file for generating links. This property is used by the default component partial.',
        'rssfeed_title' => 'RSS Feed',
        'rssfeed_description' => 'Generates an RSS feed containing posts from the catalogue.',
        'group_links' => 'Links',
