...
return [
    'plugin' => [
        'name' => 'Catalogue',
        'description' => 'Robustna platforma za catalogueanje.',
    ],
    'catalogue' => [
        'menu_label' => 'Catalogue',
        'menu_description' => 'Upravljanje cataloguea',
        'posts' => 'Objave',
        'create_post' => 'Catalogue objava',
        'categories' => 'Kategorije',
        'create_category' => 'Catalogue kategorija',
        'tab' => 'Catalogue',
        'access_posts' => 'Upravljanje catalogue objav',
        'access_categories' => 'Upravljanje catalogue kategorij',
        ...
        'manage_settings' => 'Urejanje nastavitev cataloguea',
        'delete_confirm' => 'Ali ste prepričani?',
        'chart_published' => 'Objavljeno',
        'chart_drafts' => 'Osnutki',
        'chart_total' => 'Skupaj',
        'settings_description' => 'Urejanje nastavitev cataloguea',
    ...
    'posts' => [
        'list_title' => 'Urejanje catalogue objav',
    ...
    'categories' => [
        'list_title' => 'Upravljanje catalogue kategorij',
    ...
    'category' => [
        ...
        'return_to_categories' => 'Vrnite se na seznam catalogue kategorij',
        'reorder' => 'Spremenite vrstni red kategorij',
    ],
    'menuitem' => [
        'catalogue_category' => 'Catalogue kategorija',
        'all_catalogue_categories' => 'Vse catalogue kategorije',
        'catalogue_post' => 'Catalogue objava',
        'all_catalogue_posts' => 'Vse catalogue objave',
        'category_catalogue_posts' => 'Objave v kategoriji',
    ],
    'settings' => [
        'category_title' => 'Seznam kategorij',
        'category_description' => 'Prikaži seznam catalogue kategorij na strani.',
        'category_slug' => 'Povezava kategorije',
        'category_slug_description' => 'Omogoča pregled catalogue kategorije na podani povezavi. Ta lastnost je uporabljena v privzeti predlogi komponente za označevanje trenutno aktivne kategorije.',
        ...
        'category_page_description' => 'Naslov strani catalogue kategorij za ustvarjanje povezav. Ta lastnost je uporabljena v privzeti predlogi komponente.',
        'post_title' => 'Objava',
        'post_description' => 'Prikaži catalogue objavo na strani.',
        'post_slug' => 'Povezava objave',
        'post_slug_description' => "Omogoča pregled catalogue objave na podani povezavi.",
        'post_category' => 'Stran s kategorijo',
        'post_category_description' => 'Naslov strani catalogue kategorije za ustvarjanje povezav. Ta lastnost je uporabljena v privzeti predlogi komponente.',
        'posts_title' => 'Seznam objav',
        'posts_description' => 'Prikaži seznam najnovejših catalogue objav na strani.',
        ...
        'posts_no_posts_description' => 'Sporočilo, ki se prikaže na seznamu catalogue objav, če ni nobenih objav. Ta lastnost je uporabljena v privzeti predlogi komponente.',
        ...
        'posts_category_description' => 'Naslov strani catalogue kategorije za povezave "Objavljeno v". Ta lastnost je uporabljena v privzeti predlogi komponente.',
        'posts_post' => 'Stran z objavo',
        'posts_post_description' => 'Naslov strani catalogue objave za povezave "Preberi več". Ta lastnost je uporabljena v privzeti predlogi komponente.',
        ...
        'rssfeed_catalogue' => 'Stran z catalogueom',
        'rssfeed_catalogue_description' => 'Naslov glavne strani cataloguea za ustvarjanje povezav. Ta lastnost je uporabljena v privzeti predlogi komponente.',
        'rssfeed_title' => 'RSS vir',
        'rssfeed_description' => 'Ustvari vir RSS, ki vsebuje objave iz cataloguea.',
