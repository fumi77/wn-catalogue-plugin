...
return [
    'plugin' => [
        'name' => 'Cataloguei',
        'description' => 'Vankka cataloguegausalusta.'
    ],
    'catalogue' => [
        'menu_label' => 'Cataloguei',
        'menu_description' => 'Hallitse catalogueipostauksia',
        'posts' => 'Postaukset',
        'create_post' => 'Catalogueipostaus',
        'categories' => 'Categories',
        'create_category' => 'Catalogueikategoria',
        'tab' => 'Cataloguei',
        ...
        'settings_description' => 'Hallinnoi cataloguein asetuksia',
    ...
    'posts' => [
        'list_title' => 'Hallitse catalogueipostauksia',
    ...
    'categories' => [
        'list_title' => 'Hallitse catalogueikategorioita',
    ...
    'category' => [
        ...
        'return_to_categories' => 'Palaa catalogueikategorialistaan',
        'reorder' => 'Järjestä kategoriat uudelleen'
    ],
    'menuitem' => [
        'catalogue_category' => 'Catalogueikategoria',
        'all_catalogue_categories' => 'Kaikki catalogueikategoriat',
        'catalogue_post' => 'Catalogueipostaukset',
        'all_catalogue_posts' => 'Kaikki catalogueipostaukset',
        'category_catalogue_posts' => 'Cataloguein kategorian postaukset'
    ],
    'settings' => [
        'category_title' => 'Kategorialista',
        'category_description' => 'Näyttää listan catalogueikategorioista sivulla.',
        'category_slug' => 'Kategorian slugi',
        'category_slug_description' => 'Etsii catalogueikategorian käyttämällä annettua slugi-arvoa. Komponentti käyttää tätä merkitsemään aktiivisen kategorian.',
        ...
        'post_title' => 'Postaus',
        'post_description' => 'Näyttää catalogueipostauksen sivulla.',
        'post_slug' => 'Postauksen slugi',
        'post_slug_description' => 'Etsii catalogueipostauksen käyttämällä annettua slugi-arvoa.',
        ...
        'posts_description' => 'Näyttää listan uusimmista catalogueipostauksista sivulla.',
        ...
        'posts_post_description' => 'Catalogueisivun tiedostonimi "Lue lisää" linkkejä varten. Oletuskomponenttiosa käyttää tätä ominaisuutta.',
        ...
        'rssfeed_catalogue' => 'Catalogueisivu',
        'rssfeed_catalogue_description' => 'Catalogueisivun tiedostonimi linkkien generointia varten. Oletuskomponenttiosa käyttää tätä ominaisuutta.',
        'rssfeed_title' => 'RSS syöte',
        'rssfeed_description' => 'Generoi RSS syötteen sisältäen postaukset catalogueista.',
        'group_links' => 'Linkit',
