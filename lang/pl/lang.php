<?php return [
    'plugin' => [
        'name' => 'Catalogue',
        'description' => 'Solidna platforma catalogueera',
    ],
    'catalogue' => [
        'menu_label' => 'Catalogue',
        'menu_description' => 'Zarządzaj postami na catalogueu',
        'posts' => 'Posty',
        ...
        'access_categories' => 'Zarządzaj kategoriami na catalogueu',
        ...
        'manage_settings' => 'Zarządzaj ustawieniami cataloguea',
        'delete_confirm' => 'Czy jesteś pewien?',
        'chart_published' => 'Opublikowane',
        'chart_drafts' => 'Szkice',
        'chart_total' => 'Łącznie',
        'settings_description' => 'Zarządzaj ustawieniami cataloguea',
    ...
    'menuitem' => [
        'catalogue_category' => 'Kategorie',
        'all_catalogue_categories' => 'Wszystkie kategorie',
        'catalogue_post' => 'Post na cataloguea',
        'all_catalogue_posts' => 'Wszystkie posty',
        'category_catalogue_posts' => 'Posty w kategorii',
    ],
    'settings' => [
        'category_title' => 'Lista kategorii',
        'category_description' => 'Wyświetla listę catalogueowych kategorii na stronie.',
        ...
        'rssfeed_catalogue' => 'Strona cataloguea',
        'rssfeed_catalogue_description' => 'Nazwa strony głównej cataloguea do generowania linków. Używane przez domyślny fragment komponentu.',
        'rssfeed_title' => 'Kanał RSS',
        'rssfeed_description' => 'Generuje kanał RSS zawierający posty z cataloguea.',
        'group_links' => 'Linki',
