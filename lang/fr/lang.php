...
return [
    'plugin' => [
        'name' => 'Catalogue',
        'description' => 'Une plateforme de catalogue robuste.'
    ],
    'catalogue' => [
        'menu_label' => 'Catalogue',
        'menu_description' => 'Gestion d’articles de catalogue',
        'posts' => 'Articles',
        'create_post' => 'article de catalogue',
    ...
    'posts' => [
        'list_title' => 'Gérer les articles du catalogue',
    ...
    'menuitem' => [
        'catalogue_category' => 'Catégories du catalogue',
        'all_catalogue_categories' => 'Toutes les catégories du catalogue',
        'catalogue_post' => 'Articles du catalogue',
        'all_catalogue_posts' => 'Tous les articles du catalogue',
        'category_catalogue_posts' => "Articles d'une catégorie du catalogue",
    ],
    'settings' => [
        ...
        'post_title' => 'Article',
        'post_description' => 'Affiche un article de catalogue sur la page.',
        ...
        'posts_description' => 'Affiche une liste des derniers articles de catalogue sur la page.',
        ...
        'posts_post_description' => 'Nom du fichier de la page de l\'article du catalogue pour les liens "En savoir plus". Cette propriété est utilisée par le composant par défaut du modèle partiel.',
        ...
        'rssfeed_catalogue' => 'Page du catalogue',
        'rssfeed_catalogue_description' => 'Nom de la page principale du catalogue pour générer les liens. Cette propriété est utilisé par le composant dans le partial.',
        'rssfeed_title' => 'Flux RSS',
        'rssfeed_description' => 'Génère un Flux RSS contenant les articles du catalogue.',
        'group_links' => 'Liens',
