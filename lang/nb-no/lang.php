...
return [
    'plugin' => [
        'name' => 'Catalogueg',
        'description' => 'En robust cataloguegeplattform.',
    ],
    'catalogue' => [
        'menu_label' => 'Catalogueg',
        'menu_description' => 'Administrer catalogueginnlegg',
        'posts' => 'Innlegg',
        'create_post' => 'innlegg',
        'categories' => 'Kategorier',
        'create_category' => 'kategori',
        'access_posts' => 'Administrer catalogueginnleggene',
        'access_categories' => 'Administrer cataloguegkategorier',
        'access_other_posts' => 'Administrere andre brukere sine catalogueginnlegg',
    ...
    'posts' => [
        'list_title' => 'Administrer catalogueginnlegg',
    ...
    'categories' => [
        'list_title' => 'Administrer cataloguegkategorier',
